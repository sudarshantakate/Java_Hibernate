...
public class HibernateConfig {
	...
	public static SessionFactory getSessionfacFactory() {
		...
		if (sf == null) {
			...
			map.put(Environment.URL, "jdbc:mysql://localhost:3306/collegedb");
			...
			MetadataSources metadataSources = new MetadataSources(registry).addAnnotatedClass(Employee.class).addAnnotatedClass(Company.class);// store data of all properties data
